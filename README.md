...
- Three routes:
  ...
  - `/rooms-beds/`
  - `/videos/`
- Localized Webflow assets (CSS, JS, SVGs, images, icons) under `static/assets/webflow/`.
...
- Static site now serves Webflow-hosted assets locally from this repo.
- Remaining external runtime calls are from third-party embeds/integrations (for example YouTube and Google APIs).
